...
const PREC_NAMES = [
  "Dra. Camila Braga Santana", "Dr. Thiago Damasceno Lima", "Dra. Patrícia Lopes Amorim",
  "Dr. Marcos Vieira Conceição", "Dra. Lívia Teixeira Matos", "Dr. Antônio Sampaio Neto",
  "Dra. Renata Fonseca Caires", "Dr. Nelson Cunha Montenegro", "Dra. Clarissa Monteiro Alves",
  "Dr. Jorge Barbosa Guerreiro", "Dra. Aline Nogueira Fagundes", "Dr. Fábio Ramos Miranda",
  "Dra. Sônia Correia Dourado", "Dr. Paulo Brandão Caribé", "Dra. Tereza Argôlo Pinho",
  "Dr. Ricardo Brito Paranhos", "Dra. Márcia Salgado Reis", "Dr. Eduardo Lima Duarte",
  "Dra. Daniela Portela Viana", "Dr. Luciano Sampaio Correia",
];
