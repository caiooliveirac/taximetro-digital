...
ARG NEXT_PUBLIC_ORG_OG_IMAGE=""
ARG NEXT_PUBLIC_ORG_BASE_URL=""
ENV NEXT_PUBLIC_ORG_NAME=${NEXT_PUBLIC_ORG_NAME} NEXT_PUBLIC_ORG_NAME_SHORT=${NEXT_PUBLIC_ORG_NAME_SHORT} NEXT_PUBLIC_TELEGRAM_GROUP_LINK=${NEXT_PUBLIC_TELEGRAM_GROUP_LINK} NEXT_PUBLIC_ORG_OG_IMAGE=${NEXT_PUBLIC_ORG_OG_IMAGE} NEXT_PUBLIC_ORG_BASE_URL=${NEXT_PUBLIC_ORG_BASE_URL}
